<template>
    <div class="container">
        ...
        <input type="file" name="image" multilple="" @change="fileInputChange">

        <hr>

        <div class="row">
            <div class="col-sm-6">
                <h3 class="text-center">Файлів в черзі ({{ filesOrder.length }})</h3>
                <ul class="list-group">
            ...
            <div class="col-sm-6">
                <h3 class="text-center">Завантажених файлів ({{ filesFinish.length }})</h3>
                <ul class="list-group">
                    <li class="list-group-item" v-for="file in filesFinish">{{ file.name }} : {{ file.type}}</li>
                </ul>
            </div> 
        </div>
    </div>
