...
<html lang="en">
    ...
    <p><img class=" img-fluid" src="{{ $user->avatar}}" alt="{{$user->title}}" alt="card image"></p>
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Профіль </a><button class="navbar-toggler navbar-toggler-right text-uppercase font-weight-bold bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu <i class="fas fa-bars"></i></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Статті користувача</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image--><img class="masthead-avatar mb-5" src="../{{ $user->avatar}}" alt="" /><!-- Masthead Heading-->
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Статті</h2>
                <!-- Icon Divider-->
                ...
                @foreach($user->posts as $post)
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                            ...
                            <img href="{{ route('post.single', ['slug' => $post->slug ]) }}" class="img-fluid" src="{{ $post->featured}}" alt="" />
                            <a href="{{ route('post.single', ['slug' => $post->slug ]) }}" class="masthead-subheading font-weight-light mb-0">{{$post->title}}</p>
                        </div>
                    </div>
