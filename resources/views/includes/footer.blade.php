            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">Цей вебсайт створений з метою поширення і донесення до зацікавлених в різноманітних предметних олімпіадах інформації та навчальних матеріалів, що стосуються їх. Сподіваємось Ви знайдете тут те, що шукали. Удачі!
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Пн - Пт 9:00 - 18:00</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">онлайн допомога</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">вул. Зарічанська, 10/4</p>
                        </div>
                    </div>
                </div>
            </div>
